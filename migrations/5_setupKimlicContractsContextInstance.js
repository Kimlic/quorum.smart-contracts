...
const communityTokens = 1000000000000000000
...
module.exports = function (deployer) {
  ...
  deployer.then(async () => {
    ...
    const communityTokenWalletPassword = walletPassword;
    ...
    await web3.eth.sendTransaction({ "from": deployedConfig.deployerAddress, "to": communityTokenWalletAddress, "value": communityTokens });//1 eth
