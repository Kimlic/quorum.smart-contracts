...
module.exports = function(deployer) {
    ...
    const setupParty = async (kimlicTokenInstance, name, password) => {
        ...
        const allowance = await kimlicTokenInstance.allowance.call(address, VerificationContractFactory.address, { from: address });
        ...
        const provisioningAllowance = await kimlicTokenInstance.allowance.call(address, ProvisioningContractFactory.address, { from: address });
